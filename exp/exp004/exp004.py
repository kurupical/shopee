...
def main(config):
    ...
    if config.debug:
        ...
        df_train = df[df["label_group"] <= 10000].reset_index(drop=True)
        df_val = df[df["label_group"] > 10000].reset_index(drop=True)
