...
DEBUG = True
EXPERIMENT_NAME = "transformer_decoder"
...
class ShopeeNet(nn.Module):
    def __init__(self,
        ...
        decoder_layer_concat = nn.TransformerDecoderLayer(d_model=self.bert.hidden_size,
                                                          nhead=config.transformer_n_heads,
                                                          dropout=config.dropout_transformer)

        self.transformer_cnn = nn.TransformerEncoder(encoder_layer=encoder_layer_cnn,
                                                     num_layers=config.transformer_num_layers)
        self.transformer_concat = nn.TransformerDecoder(decoder_layer=decoder_layer_concat,
                                                        num_layers=config.transformer_num_layers)
