...
"""
とりあえずこれベースに頑張って写経する
http://34.121.203.133:5000/#/experiments/7/runs/5822275cb8ab4800b316089e32e2b9e5
"""
...
def main_process():
    ...
    for model_name in ["swin_large_patch4_window7_224"]:
        cfg = Config(experiment_name=f"[ALL]/nlp_model=distilbert-indonesian/cnn_model={model_name}/")
