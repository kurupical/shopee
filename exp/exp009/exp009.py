...
class Config:
    ...
    scheduler = StepLR
    scheduler_params = {"step_size": 1, "gamma": 0.999}
    ...
    for fold in [0]:
        ...
        for epoch in range(config.epochs):
            ...
            if score > best_score:
                ...
                not_improved_epochs = 0
                print('best model found for epoch {}, {:.4f} -> {:.4f}'.format(epoch, score, best_score))
...
if __name__ == "__main__":
    ...
    for nlp_model_name in ["bert-base-multilingual-uncased",
