...
class ShopeeNet(nn.Module):
    def __init__(self,
        ...
        self.fc = nn.Sequential(
            nn.Linear(n_feat_concat, n_feat_concat),
            nn.BatchNorm1d(n_feat_concat)
        )
...
def main_process():
    ...
    for model in [#"swin_base_patch4_window7_224",
                  "swin_large_patch4_window7_224"]:
        cfg = Config(experiment_name=f"[residual_x_fc]cnn={model}/nlp_model=distilbert-indonesian/")
