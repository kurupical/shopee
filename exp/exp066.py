...
EXPERIMENT_NAME = "progressive learning(512-640-768)_2epoch"
DEBUG = False
...
class Config:
    ...
    if DEBUG:
        ...
        progressive_learning_epoch_span = 2
    progressive_learning_epoch_imgsize = [512, 640, 768, 768, 768, 768, 768]
